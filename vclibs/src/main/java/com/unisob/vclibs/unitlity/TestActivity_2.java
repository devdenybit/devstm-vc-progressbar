...
import com.unisob.vclibs.databinding.ActivityTest2Binding;
...
public class TestActivity_2 extends AppCompatActivity {
    ...
    public void next_call() {
        startActivity(new Intent(TestActivity_2.this, HomePageActivity.class).putExtra("rate", true));
        finish();
    }
        ...
        ((TextView) dialog.findViewById(R.id.reyes)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (c1.isChecked() || c2.isChecked() || c3.isChecked() || c4.isChecked() || c5.isChecked() || c6.isChecked() || c7.isChecked()) {
                    ...
                    Toast.makeText(TestActivity_2.this, "Select Reason", Toast.LENGTH_SHORT).show();
                }
            }
        });
        dialog.show();
