...
import static com.gerop.mpsvue.mainaods.MainAppManage.app_DataIOSocketFail;
...
public class TestActivity_7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // MainAppManage.getInstance(this).showNative((ViewGroup) findViewById(com.unisob.vclibs.R.id.native_container), ADMOB_N0, FACEBOOK_N[0]);
