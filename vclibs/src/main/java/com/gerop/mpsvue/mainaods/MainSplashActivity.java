...
import static com.gerop.mpsvue.mainaods.MainAppManage.app_onesingle_appid;
...
public class MainSplashActivity extends Subs_SplashActivity {
    ...
    public static void All_Data(Activity context, Intent intent){
        ADSinit(context, getCurrentVersionCode(context), new getDataListner() {
            ...
            public void onSuccess() {
                ...
                MainAppManage.getInstance(context).showNative((ViewGroup) context.findViewById(R.id.native_container), ADMOB_N0, FACEBOOK_N[0]);
                MainAppManage.getInstance(context).loadInterstitialAd(context);
