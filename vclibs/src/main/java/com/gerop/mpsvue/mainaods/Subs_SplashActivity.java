...
import static com.gerop.mpsvue.mainaods.MainAppManage.mysharedpreferences;
...
import com.gerop.mpsvue.BuildConfig;
...
public class Subs_SplashActivity extends AppCompatActivity {
                ...
                new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response1)
                    {
                        try {
                            ...
                            MainAppManage.getInstance(activity).getResponseFromPref(new getDataListner() {
                                @Override
